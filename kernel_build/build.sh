...
OUT_KERNELZIP="$(pwd)/kernel_build/FireAsf-${FIRE_VERSION}-Unstable229-02_a53x.zip"
OUT_KERNELTAR="$(pwd)/kernel_build/FireAsf-${FIRE_VERSION}-Unstable229-02_a53x.tar"
...
# Kernel-side
BUILD_ARGS="LOCALVERSION=-FireAsf-${FIRE_VERSION}-Unstable KBUILD_BUILD_USER=Ksawlii KBUILD_BUILD_HOST=FireAsFuck"
